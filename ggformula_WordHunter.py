...
with col1:
    ...
    # Immediate filtering (no buttons) + show count like the praised version
...
with col2:
    ...
    chosen = st.selectbox("Quick pick — choose a word", [""] + matches[:1000])
...
# Footer tip
st.markdown("<div class='small-muted' style='margin-top:10px'>Tip: Short suffixes (ex: 'ing', 'ight') + exact letters-before-suffix help you narrow results. Pick a short suffix and adjust the before-letters to narrow results.</div>", unsafe_allow_html=True)
