...
# Header
st.markdown("<div class='app-header'><h1 style='margin:0'>🎈 சொல் இறுதி பயிற்சி — வார்த்தைகளுடன் விளையாடு</h1><small>Suffix அடிப்படையில் சொற்களைத் தேடவும், அர்த்தங்களுடன் பார்க்கவும்</small></div>", unsafe_allow_html=True)
